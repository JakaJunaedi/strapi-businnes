(self.webpackChunkonline_server=self.webpackChunkonline_server||[]).push([[2544],{4644:(H,L,o)=>{"use strict";o.d(L,{V:()=>P});var e=o(80120),E=o(88767);const P=(b={},O={})=>{const{id:A,...x}=b,{get:v}=(0,e.kY)();if(!A&&(O?.enabled===void 0||O?.enabled))throw new Error('"id" is a required argument');const{data:M,error:W,isError:a,isLoading:B,refetch:p}=(0,E.useQuery)(["roles",A,"permissions",x],async()=>{const{data:{data:S}}=await v(`/admin/roles/${A}/permissions`,{params:x});return S},O);return{permissions:M,error:W,isError:a,isLoading:B,refetch:p}}},51754:(H,L,o)=>{"use strict";o.d(L,{F:()=>b});var e=o(80120),E=o(86896),P=o(88767);const b=(O={},A={})=>{const{id:x="",...v}=O,{get:M}=(0,e.kY)(),{locale:W}=(0,E.Z)(),a=(0,e.Xe)(W,{sensitivity:"base"}),{data:B,error:p,isError:S,isLoading:F,refetch:g}=(0,P.useQuery)(["roles",x,v],async()=>{const{data:V}=await M(`/admin/roles/${x??""}`,{params:v});return V},A);let y=[];return x&&B?y=[B.data]:Array.isArray(B?.data)&&(y=B.data),{roles:y.sort((V,oe)=>a.compare(V.name,oe.name)),error:p,isError:S,isLoading:F,refetch:g}}},25545:(H,L,o)=>{"use strict";o.r(L),o.d(L,{CreatePage:()=>Re,default:()=>Se});var e=o(67294),E=o(185),P=o(53979),b=o(11047),O=o(29728),A=o(49066),x=o(41580),v=o(75515),M=o(11276),W=o(67819),a=o(16364),B=o(61467),p=o(80120),S=o(67109),F=o(66115),g=o(41054),y=o(41609),V=o.n(y),oe=o(86896),ce=o(86706),re=o(16550),C=o(71997),me=o(4644),X=o(36364),G=o(442),_=o(90065),Ce=o(87561);const xe=Ce.Ry().shape({name:Ce.Z_().required(p.I0.required),description:Ce.Z_().required(p.I0.required)}),ae=C.ZP.div`
