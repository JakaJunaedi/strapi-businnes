"use strict";
(self["webpackChunkonline_server"] = self["webpackChunkonline_server"] || []).push([[8056],{
...
const ApiTokenListView = () => {
  ...
  } = (0,helper_plugin_esm/* useRBAC */.ss)(permissions.settings["api-tokens"]);
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(helper_plugin_esm/* SettingsPageTitle */.SL, { name: "API Tokens" }), /* @__PURE__ */ react.createElement(
    ...
    helper_plugin_esm/* NoContent */.dJ,
    {
      ...
      action: /* @__PURE__ */ react.createElement(helper_plugin_esm/* LinkButton */.Qj, { variant: "secondary", startIcon: /* @__PURE__ */ react.createElement(Plus/* default */.Z, null), to: "/settings/api-tokens/create" }, formatMessage({
...
const ProtectedApiTokenListView = () => {
  const permissions = (0,es/* useSelector */.v9)(selectors/* selectAdminPermissions */._);
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.O4, { permissions: permissions.settings["api-tokens"].main }, /* @__PURE__ */ react.createElement(ListView, null));
};
