"use strict";
(self["webpackChunkonline_server"] = self["webpackChunkonline_server"] || []).push([[4409],{
...
function ReviewWorkflowsEditView() {
  ...
  const {
    ...
    refetch
  } = (0,useReviewWorkflows/* useReviewWorkflows */.n)();
  ...
  const { getFeature, isLoading: isLicenseLoading } = (0,hooks/* useLicenseLimits */.q5)();
  ...
  react.useEffect(() => {
    dispatch((0,actions/* setWorkflow */.fC)({ status: workflowStatus, data: workflow }));
    return () => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Layout/* DragLayerRendered */.lx, null), /* @__PURE__ */ react.createElement(formik_esm/* FormikProvider */.Hy, { value: formik }, /* @__PURE__ */ react.createElement(formik_esm/* Form */.l0, { onSubmit: formik.handleSubmit }, /* @__PURE__ */ react.createElement(
  ...
  ), /* @__PURE__ */ react.createElement(Layout/* Root */.fC, null, isLoadingModels || status === "loading" ? /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Loader/* Loader */.a, null, formatMessage({
    ...
    /* @__PURE__ */ react.createElement(helper_plugin_esm/* ConfirmDialog */.QH.Body, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", gap: 5 }, savePrompts.hasDeletedServerStages && /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textAlign: "center", variant: "omega" }, formatMessage({
...
/* harmony default export */ function EditView() {
  const permissions = (0,es/* useSelector */.v9)(selectors/* selectAdminPermissions */._);
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.O4, { permissions: permissions.settings["review-workflows"].main }, /* @__PURE__ */ react.createElement(ReviewWorkflowsEditView, null));
}
