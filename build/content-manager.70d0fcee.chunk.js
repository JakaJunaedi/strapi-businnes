(self["webpackChunkonline_server"] = self["webpackChunkonline_server"] || []).push([[994],{
...
var Menu = __webpack_require__(60188);
...
const LinkToCTB = () => {
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPermissions */.jW, { permissions }, /* @__PURE__ */ react.createElement(
...
var SimpleMenu = __webpack_require__(40714);
...
var useDebounce = __webpack_require__(63109);
...
const RelationInput = ({
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 3, justifyContent: "space-between", alignItems: "end", wrap: "wrap" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", basis: size <= 6 ? "100%" : "70%", gap: 2 }, /* @__PURE__ */ react.createElement(
...
const EditView = ({ allowedActions, isSingleType, goBack, slug, id, origin, userPermissions }) => {
  ...
  const Information = (0,useEnterprise/* useEnterprise */.c)(
    InformationBoxCE,
    async () => (await __webpack_require__.e(/* import() */ 3757).then(__webpack_require__.bind(__webpack_require__, 23037))).InformationBoxEE
  );
  useOnce(() => {
...
const CheckboxDataCell = ({ rowId, index }) => {
  const { selectedEntries, onSelectRow } = (0,helper_plugin_esm/* useTableContext */.Sh)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
...
const EntityActionsDataCell = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { trackUsage } = (0,helper_plugin_esm/* useTracking */.rS)();
  const { setSelectedEntries } = (0,helper_plugin_esm/* useTableContext */.Sh)();
  const pluginsQueryParams = (0,hooks/* usePluginsQueryParams */.fi)();
  const {
    location: { pathname }
...
const Root = ({ children, onConfirmDelete, isConfirmDeleteRowOpen, setIsConfirmDeleteRowOpen }) => {
  ...
  const { selectedEntries, setSelectedEntries } = (0,helper_plugin_esm/* useTableContext */.Sh)();
  const handleConfirmDelete = async () => {
    try {
      setIsLoading(true);
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* Table */.iA.Body, null, children, /* @__PURE__ */ react.createElement(
    ConfirmDialogDelete,
    {
...
const ConfirmDialogPublishAll = ({ isOpen, onToggleDialog, isConfirmButtonLoading, onConfirm }) => {
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { get } = (0,helper_plugin_esm/* useFetchClient */.kY)();
  const { selectedEntries } = (0,helper_plugin_esm/* useTableContext */.Sh)();
  const toggleNotification = (0,helper_plugin_esm/* useNotification */.lm)();
  const { formatAPIError } = (0,helper_plugin_esm/* useAPIErrorHandler */.So)(utils/* getTrad */.OB);
  const {
...
var CrossCircle = __webpack_require__(58034);
...
const SelectedEntriesModalContent = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { selectedEntries, rows, onSelectRow, isLoading, isFetching } = (0,helper_plugin_esm/* useTableContext */.Sh)();
...
const SelectedEntriesModal = ({ onToggle }) => {
  ...
  } = (0,helper_plugin_esm/* useTableContext */.Sh)();
  ...
  ] = (0,helper_plugin_esm/* useQueryParams */.Kx)();
  const queryParams = {
    page: 1,
  ...
  const { data, isLoading, isFetching, refetch } = (0,react_query_es.useQuery)(
    ...
    async () => {
      ...
      if (data2.results) {
        const schema = (0,utils/* createYupSchema */.Ex)(contentType, { components }, { isDraft: false });
        ...
        const rows = data2.results.map((entry) => {
          try {
            ...
            validationErrors[entry.id] = (0,helper_plugin_esm/* getYupInnerErrors */.CJ)(e);
            return entry;
          }
        });
  ...
  return /* @__PURE__ */ react.createElement(
    helper_plugin_esm/* Table */.iA.Root,
    {
      rows: data?.rows,
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 1, paddingBottom: 1 }, /* @__PURE__ */ react.createElement(
    Select/* Select */.P,
    {
      ...
      customizeContent: (values2) => formatMessage(
        {
          id: (0,utils/* getTrad */.OB)("select.currently.selected"),
...
function ListView({
  ...
  const ReviewWorkflowsStage = (0,useEnterprise/* useEnterprise */.c)(
    REVIEW_WORKFLOW_COLUMNS_CELL_CE,
    async () => (await __webpack_require__.e(/* import() */ 934).then(__webpack_require__.bind(__webpack_require__, 80934))).ReviewWorkflowsStageEE,
    {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(
    ...
    ActionLayout/* ActionLayout */.Z,
    {
      endActions: /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(components_InjectionZone, { area: "contentManager.listView.actions" }), /* @__PURE__ */ react.createElement(FieldPicker, { layout }), /* @__PURE__ */ react.createElement(
        helper_plugin_esm/* CheckPermissions */.jW,
        {
  ...
  ), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, canRead ? /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 4, direction: "column", alignItems: "stretch" }, /* @__PURE__ */ react.createElement(helper_plugin_esm/* Table */.iA.Root, { rows: data, isLoading, colCount }, /* @__PURE__ */ react.createElement(helper_plugin_esm/* Table */.iA.ActionBar, null, /* @__PURE__ */ react.createElement(
  ...
  )), /* @__PURE__ */ react.createElement(helper_plugin_esm/* Table */.iA.Content, null, /* @__PURE__ */ react.createElement(helper_plugin_esm/* Table */.iA.Head, null, /* @__PURE__ */ react.createElement(helper_plugin_esm/* Table */.iA.HeaderCheckboxCell, null), tableHeaders.map(({ fieldSchema, key, name, metadatas: metadatas2 }) => /* @__PURE__ */ react.createElement(
    helper_plugin_esm/* Table */.iA.HeaderCell,
    {
      key,
      name,
  ...
  )), /* @__PURE__ */ react.createElement(helper_plugin_esm/* Table */.iA.HeaderHiddenActionsCell, null)), /* @__PURE__ */ react.createElement(helper_plugin_esm/* Table */.iA.LoadingBody, null), /* @__PURE__ */ react.createElement(
    helper_plugin_esm/* Table */.iA.EmptyBody,
    {
  ...
  ))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "flex-end", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(helper_plugin_esm/* PageSizeURLQuery */.v4, { trackedEvent: "willChangeNumberOfEntriesPerPage" }), /* @__PURE__ */ react.createElement(helper_plugin_esm/* PaginationURLQuery */.tU, { pagination: { pageCount: pagination?.pageCount || 1 } }))) : /* @__PURE__ */ react.createElement(helper_plugin_esm/* NoPermissions */.ZF, null)));
}
ListView.propTypes = {
  canCreate: (prop_types_default()).bool.isRequired,
  canDelete: (prop_types_default()).bool.isRequired,
...
const CollectionTypeRecursivePath = ({
  ...
  return /* @__PURE__ */ react.createElement(react_error_boundary_umd.ErrorBoundary, { FallbackComponent: components_ErrorFallback }, /* @__PURE__ */ react.createElement(contexts_ContentTypeLayout.Provider, { value: layout }, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: `${url}/configurations/list` }, /* @__PURE__ */ react.createElement(
    helper_plugin_esm/* CheckPagePermissions */.O4,
    {
      permissions: permissions.contentManager.collectionTypesConfigurations
    },
    /* @__PURE__ */ react.createElement(
...
const ComponentSettingsView = () => {
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.O4, { permissions: permissions.contentManager.componentsConfigurations }, /* @__PURE__ */ react.createElement(pages_EditSettingsView, { components: layout.components, mainLayout: layout.component, slug: uid }));
};
...
// EXTERNAL MODULE: ./node_modules/react-intl/lib/src/components/useIntl.js
var useIntl = __webpack_require__(86896);
// EXTERNAL MODULE: ./.cache/admin/src/utils/index.js + 6 modules
var utils = __webpack_require__(35209);
// EXTERNAL MODULE: ./.cache/admin/src/content-manager/utils/index.js + 11 modules
var content_manager_utils = __webpack_require__(21892);
